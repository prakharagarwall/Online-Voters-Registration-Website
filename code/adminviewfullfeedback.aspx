<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminviewfullfeedback.aspx.cs" Inherits="adminviewfullfeedback" %>
...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="background-color: #FFFFCC; " class="auto-style8">
        ...
        <tr>
            <td colspan="9" class="auto-style1" style="text-align: center">
                <table class="auto-style17" style="text-align: center; height: 116px;">
                    <tr>
                        <td class="auto-style18" style="text-align: right; color: #FF0000;">Name:&nbsp;
                            <asp:Label ID="LabelName1" runat="server"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                        <td style="text-align: left; color: #FF0000;">Email:&nbsp;
                            <asp:Label ID="Labelemail" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">Feedback:&nbsp;&nbsp; <asp:Label ID="Labelfeedback" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                <br />
                <br />
                <asp:Button ID="Button2" runat="server" PostBackUrl="~/adminviewfeedback.aspx" Text="Go Back" />
            </td>
        </tr>
    </table>
    </div>
