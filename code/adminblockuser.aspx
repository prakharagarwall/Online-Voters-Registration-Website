<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminblockuser.aspx.cs" Inherits="adminblockuser" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="background-color: #FFFFCC; " class="auto-style8">
        ...
        <tr>
            <td colspan="9" class="auto-style1">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" Height="60px" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Center" OnRowUpdating="GridView1_RowUpdating" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="Operation">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" Text='<%# Bind("block") %>' CommandName="update"></asp:LinkButton>
