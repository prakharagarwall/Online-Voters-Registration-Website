<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminviewprofile.aspx.cs" Inherits="adminviewprofile" %>
...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="background-color: #FFFFCC; " class="auto-style8">
        ...
        <tr>
            ...
            <td style="border: thin solid #FFFFFF; text-align: center;" class="auto-style28">
                ...
                <table style="height: 351px; width: 1076px; font-size: large; background-color: #FFFFCC;">
                    ...
                    <tr>
                        <td class="auto-style22" colspan="4" style="background-color: #FFFFCC" >
                            <asp:Button ID="Button2" runat="server" PostBackUrl="~/adminviewuser.aspx" Text="Go Back" />
                        </td>
                    </tr>
                </table>
            </td>
