<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admindeletenotice.aspx.cs" Inherits="admindeletenotice" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="background-color: #FFFFCC; " class="auto-style8">
        <tr>
         ...
         <tr>
            ...
            </td><td style="border: thin solid #FFFFFF; text-align: center; " class="auto-style19">
        ...
        <tr>
            <td colspan="10" class="auto-style1"><br />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="2px" DataKeyNames="date,title" DataSourceID="SqlDataSource1" EnableModelValidation="True" HorizontalAlign="Center" BackColor="#CCCCFF">
                    <AlternatingRowStyle BackColor="#CCFFFF" />
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" />
                        <asp:BoundField DataField="date" HeaderText="date" SortExpression="date" />
                        <asp:BoundField DataField="title" HeaderText="title" SortExpression="title" />
                        <asp:BoundField DataField="visible_to" HeaderText="visible_to" SortExpression="visible_to" />
                    </Columns>
                    <HeaderStyle BackColor="#66CCFF" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Center" />
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PlacementPortalConnectionString3 %>" DeleteCommand="DELETE FROM NOTICE where date=@date and title=@title" SelectCommand="SELECT [date], [title], [visible_to] FROM [notice]">
                    <DeleteParameters>
