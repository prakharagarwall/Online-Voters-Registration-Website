<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="welcomeuser.aspx.cs" Inherits="welcomeuser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" cellpadding="0" cellspacing="0" class="auto-style12" style="background-color: #FFFFCC">
        ...
        <tr>
            ...
            <td class="auto-style15" colspan="3" style="background-color: #FFFF99; text-align: center;">



                <table class="auto-style16">
                    <tr>
                        <td style="background-color: #CCCCFF" class="auto-style18">
        ...
        <tr><td colspan="3" style="font-size: xx-large; font-style: normal; text-decoration: blink; text-align: center; color: #FF0000;">
